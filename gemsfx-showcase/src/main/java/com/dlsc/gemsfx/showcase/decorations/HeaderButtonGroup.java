...
public class HeaderButtonGroup extends Control {
    ...
    protected Subscription stageMaximizedSubscription;
    protected Subscription stageFocusedSubscription;
     ...
     */
    public void install(HeaderBar headerBar, Stage stage, Alignment alignment) {

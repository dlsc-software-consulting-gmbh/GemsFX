...
public class Utils {
    ...
    public static Screen getScreenForRectangle(Rectangle2D rect) {
        ...
        for (Screen screen : screens) {
            ...
            double dx = getOuterDistance(rectX0, rectX1,
                    screenBounds.getMinX(),
                    screenBounds.getMaxX());
            double dy = getOuterDistance(rectY0, rectY1,
                    screenBounds.getMinY(),
                    screenBounds.getMaxY());
    ...
    public static Screen getScreenForPoint(double x, double y) {
        ...
        for (Screen screen : screens) {
            Rectangle2D screenBounds = screen.getBounds();
            double dx = getOuterDistance(screenBounds.getMinX(),
                    screenBounds.getMaxX(),
                    x);
            double dy = getOuterDistance(screenBounds.getMinY(),
                    screenBounds.getMaxY(),
                    y);
            double distance = dx * dx + dy * dy;
            if (minDistance >= distance) {
    ...
    private static double getOuterDistance(double v0,
                                           double v1,
                                           double v) {
        // (v0 <= v1)
        if (v <= v0) {

...
public class PhoneNumberField extends Control {
    ...
    /**
     * Country calling code representation.
     */
     ...
     */
    public enum DefaultCountryCallingCodes implements CountryCallingCode {
        ...
        DefaultCountryCallingCodes(int countryCode, String iso2Code, int... areaCodes) {

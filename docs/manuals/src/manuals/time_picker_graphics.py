"""Generates cartoon illustrations for the TimePicker manual."""
...
OUT = Path(__file__).resolve().parent.parent / "graphics" / "time-picker"
LINE = "#B7C2D0"
CONTROL = "TimePicker"
TITLE = "14:30"
ITEMS = ['08', '09', '10', '11', '12', '13', '14', '15', '30', '45']
LEGEND = ['time', 'format', 'stepRate', 'popup lists']

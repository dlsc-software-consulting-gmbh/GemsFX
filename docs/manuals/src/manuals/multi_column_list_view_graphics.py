"""Generates cartoon illustrations for the MultiColumnListView manual."""
...
OUT = Path(__file__).resolve().parent.parent / "graphics" / "multi-column-list-view"
CONTROL="MultiColumnListView"; KIND="board"; ITEMS=['Backlog', 'To Do', 'Doing', 'Done']; LEGEND=['columns', 'headers', 'cards', 'drag markers']; LINE="#B7C2D0"

"""Generates cartoon illustrations for the YearMonthView manual."""
...
OUT = Path(__file__).resolve().parent.parent / "graphics" / "year-month-view"
LINE = "#B7C2D0"
CONTROL = "YearMonthView"
TITLE = "2026"
ITEMS = ['Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun', 'Jul', 'Aug', 'Sep', 'Oct', 'Nov', 'Dec']
LEGEND = ['value', 'bounds', 'converter', 'showYear']

"""Generates cartoon illustrations for the YearView manual."""
...
OUT = Path(__file__).resolve().parent.parent / "graphics" / "year-view"
LINE = "#B7C2D0"
CONTROL = "YearView"
TITLE = "2020-2039"
ITEMS = ['2020', '2021', '2022', '2023', '2024', '2025', '2026', '2027', '2028', '2029', '2030', '2031', '2032', '2033', '2034', '2035', '2036', '2037', '2038', '2039']
LEGEND = ['value', 'rows x cols', 'bounds', 'page arrows']

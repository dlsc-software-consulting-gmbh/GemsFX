"""Generates cartoon illustrations for the GridTableView manual."""
...
OUT = Path(__file__).resolve().parent.parent / "graphics" / "grid-table-view"
CONTROL="GridTableView"; KIND="grid"; ITEMS=['Name', 'Age', 'Math', 'Art']; LEGEND=['GridPane', 'columns', 'cells', 'loading']; LINE="#B7C2D0"

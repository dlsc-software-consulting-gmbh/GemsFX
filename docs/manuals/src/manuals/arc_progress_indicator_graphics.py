"""Generates cartoon illustrations for the ArcProgressIndicator manual."""
...
OUT = Path(__file__).resolve().parent.parent / "graphics" / "arc-progress-indicator"
IS_CIRCLE = False
IS_SEMI = False

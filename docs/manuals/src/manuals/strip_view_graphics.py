"""Generates cartoon illustrations for the StripView manual."""
...
OUT = Path(__file__).resolve().parent.parent / "graphics" / "strip-view"
CONTROL="StripView"; KIND="strip"; ITEMS=['Item 1', 'Item 2', 'Item 3', 'Item 4', 'Item 5', 'Item 6']; LEGEND=['MaskedView', 'strip cells', 'selected item', 'scrollers']; LINE="#B7C2D0"

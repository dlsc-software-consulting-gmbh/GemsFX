"""Generates cartoon illustrations for the TreeNodeView manual."""
...
OUT = Path(__file__).resolve().parent.parent / "graphics" / "tree-node-view"
CONTROL="TreeNodeView"; KIND="tree"; ITEMS=['Root', 'A', 'B', 'C', 'A1', 'A2', 'B1']; LEGEND=['TreeNode', 'TreeNodeCell', 'links', 'layout direction']; LINE="#B7C2D0"

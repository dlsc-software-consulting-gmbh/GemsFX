"""Generates cartoon illustrations for the TimeRangePicker manual."""
...
OUT = Path(__file__).resolve().parent.parent / "graphics" / "time-range-picker"
LINE = "#B7C2D0"
CONTROL = "TimeRangePicker"
TITLE = "10:00 ~ 16:00"
ITEMS = ['10-12', '12-14', '14-16', '16-18']
LEGEND = ['items', 'selection', 'merge', 'clear/all']

"""Generates cartoon illustrations for the AdvancedTableView manual."""
...
OUT = Path(__file__).resolve().parent.parent / "graphics" / "advanced-table-view"
CONTROL="AdvancedTableView"; KIND="table"; ITEMS=['Name', 'Age', 'City']; LEGEND=['TableView', 'advanced header', 'auto resize', 'leaf columns']; LINE="#B7C2D0"

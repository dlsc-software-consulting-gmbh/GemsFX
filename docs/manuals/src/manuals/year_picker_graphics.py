"""Generates cartoon illustrations for the YearPicker manual."""
...
OUT = Path(__file__).resolve().parent.parent / "graphics" / "year-picker"
LINE = "#B7C2D0"
CONTROL = "YearPicker"
TITLE = "2026"
ITEMS = ['2020', '2021', '2022', '2023', '2024', '2025', '2026', '2027', '2028', '2029', '2030', '2031']
LEGEND = ['editor', 'calendar button', 'YearView popup', 'commit']

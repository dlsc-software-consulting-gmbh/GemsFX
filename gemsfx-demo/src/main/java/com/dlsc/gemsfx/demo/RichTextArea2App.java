...
import com.dlsc.gemsfx.rtf.RTDocument;
import com.dlsc.gemsfx.rtf.RTHeading;
import com.dlsc.gemsfx.rtf.RTLink;
import com.dlsc.gemsfx.rtf.RTList;
import com.dlsc.gemsfx.rtf.RTListItem;
import com.dlsc.gemsfx.rtf.RTParagraph;
import com.dlsc.gemsfx.rtf.RTText;
import com.dlsc.gemsfx.rtf.RichTextArea2;
import javafx.application.Application;
import javafx.scene.Scene;
import javafx.stage.Stage;

public class RichTextArea2App extends Application {

    @Override
    public void start(Stage stage) {
        RichTextArea2 area = new RichTextArea2();
        area.setDocument(
                RTDocument.create(

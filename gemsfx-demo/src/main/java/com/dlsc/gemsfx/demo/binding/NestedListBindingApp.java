...
import com.dlsc.gemsfx.binding.NestedListBinding;
...
/**
 * This demo shows how to use the {@link NestedListBinding} class to create a binding that aggregates
...
public class NestedListBindingApp extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        NestedListBinding<Number, Integer> totalSumBinding = new NestedListBinding<>(
                scores,
        ...
        NestedListBinding<Number, Double> averageBinding = new NestedListBinding<>(
                scores,
        ...
        HBox statsBox = new HBox(20, totalLabel, averageLabel);
        VBox root = new VBox(10, listView, statsBox, buttonBox);
